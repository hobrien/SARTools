...
- varInt: `r varInt`
- condRef: `r condRef`
- batch: `r ifelse(is.null(batch),"NULL",paste(batch, collapse=', '))`
- interaction: `r ifelse(is.null(interact),"NULL",paste(interact, collapse=', '))`
- RIN_cutoff: `r RIN_cutoff`
- PCW_cutoff: `r ifelse(is.null(PCW_cutoff), "NULL", paste(PCW_cutoff, collapse='-'))`
- fitType: `r fitType`
...
- locfunc: `r locfunc`
- brainBank: `r BrainBank`
- excludedSamples: `r ifelse(is.null(exclude), "NULL", paste(exclude, collapse=', '))`
- ExcludedGenes: `r ifelse(is.null(excludedFeaturesFile),"NULL",paste(excludedFeaturesFile,collapse=", "))`
